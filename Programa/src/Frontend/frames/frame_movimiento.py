...
seleccion_destino_var = None
origen_movimiento_var = None
lista_destinos_frame  = None
...
def construir(ventana, on_volver):
    ...
    """
    global seleccion_destino_var, origen_movimiento_var, lista_destinos_frame
    ...
    lista_destinos_frame = tk.Frame(panel_destinos, bg=estilos.COLOR_FONDO)
...
def actualizar(on_volver_callback=None):
    ...
    """
    global callback_volver
    if on_volver_callback:
        callback_volver = on_volver_callback
